...
import type { FlowPhase, FlowSubstepId } from '@/config/flowConfig';
import type { UserStage } from '@/lib/user-stage';
import { SPECIAL_USER_STAGES, USER_STAGE_GROUPS, UserStagesInBackend } from '@/lib/user-stage';
...
export function resolveFlowPositionFromUserStage(
  ...
  // Personal and employment details are collected on one screen.
  ...
  // APPLICATION_STATUS is routed via stageMapping + findPositionBySubstepId in useFlowStore.
